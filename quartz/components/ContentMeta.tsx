    ...
    if (text) {
      ...
      return (
        <p class={classNames(displayClass, "content-meta")}>
          ...
          ✏️ <a href={`https://github.com/ALifeLivedFully-Domain/Notes.ALifeLivedFully.com/blob/v4/${fileRelativePath}`} class={classNames(displayClass, "external")} target={"_blank"} style={"font-weight:400"}>
